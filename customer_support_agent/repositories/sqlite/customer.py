...
class CustomersRepository:
    ...
    def create_or_get(self,email: str, name: str | None = None,company: str | None = None)-> dict[str, Any] |None:
        ...
        with connect() as conn:
            ...
            conn.execute("INSERT INTO customers (email, name, company) VALUES (?, ?, ?)",
                (email, name, company),
            )
