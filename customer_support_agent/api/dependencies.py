...
from customer_support_agent.services.copilot_services import SupportCopilot
from customer_support_agent.services.draft_services import DraftService
from customer_support_agent.services.knowledge_services import KnowledgeService
...
def get_copilot_or_503() -> SupportCopilot:
    try:
        ...
        raise HTTPException(
            status_code=503,
            detail=f"Copilot unavailable: {exc}"
        ) from exc
