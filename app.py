...
# Draft generation can include tool calls and a fallback synthesis pass.
# Keep this separately configurable from the short CRUD request timeout.
DRAFT_REQUEST_TIMEOUT_SECONDS = float(os.getenv("DRAFT_REQUEST_TIMEOUT_SECONDS", "180"))
